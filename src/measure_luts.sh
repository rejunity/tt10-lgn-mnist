...
# time yosys -p "read_verilog ${CFG}.v project.v net.v; synth_xilinx -abc9 -top tt_um_rejunity_lgn_mnist -json xilinx.json" 2>&1 | tee ${TYPE}_LUTX6_${NAME}.log | grep -E "ERROR|^===|^--|LUT|LCs:"
